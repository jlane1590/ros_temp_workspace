...
public:
	...
	bool setMultipleTargets(unsigned char numChannels, unsigned char firstChannel, unsigned short *targets);

  bool setMultiplePos(unsigned char numChannels, unsigned char firstChannel, double *positions, bool crc_en);
...
private:
	static const unsigned int mMinChannelValue = 2344;   	// Change tuuzdu
	static const unsigned int mMaxChannelValue = 9296;		// Change tuuzdu
  const double servoRange = 3.141592654;
  const double homePos = 0.0;
  static const unsigned int baseValue = 5820;

	//for CRC checking
	const unsigned char CRC7_POLY = 0x91;

  unsigned short degToPulse(double posD);
